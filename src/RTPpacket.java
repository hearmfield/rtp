...
public class RTPPacket {
    ...
    public byte computeChecksum(){
    	...
    	byte h1 = (byte) (header[14] << 24);
    	byte h2 = (byte) (header[15] << 16);
    	byte h3 = (byte) (header[16] << 8);
    	byte h4 = (byte) (header[17]);
    	byte result1 = (byte) (h1 + h2);
    	byte result2 = (byte) (h3 + h4);
    	//check for carry outs
    	byte result = (byte) (result1 + result2);
    	result = (byte) ~result;
        return result;
